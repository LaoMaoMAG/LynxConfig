...
public static class Utilities
{
    ...
    public static void CopyProperties<TObj>(TObj source, TObj target, HashSet<string>? hiddenMemberList = null)
    {
        foreach (var prop in typeof(TObj).GetProperties())
        {
            // 排除隐藏成员
            if (hiddenMemberList != null && hiddenMemberList.Contains(prop.Name)) continue;
